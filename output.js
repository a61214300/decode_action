//Tue Mar 03 2026 05:52:04 GMT+0000 (Coordinated Universal Time)
    ...
    try {
      {
        ...
        return await this.taskApi(_0x2d1eeb, _0x14bc5b, _0x55aee2, _0x50e81f, {
          ...
          if (_0x15ae2a?.["code"] === "success") {
            console.log("账号[" + this.index + "] 查询盲盒成功，当前可开盲盒数：" + (_0x15ae2a?.["data"]?.["length"] || 0) + " 个");
            return _0x15ae2a?.["data"];
        ...
        return await this.taskApi(_0x4030e5, _0x481a4c, _0x1fb771, _0x3ebf33, {
        ...
        }).then(async _0x52c40c => {
          {
            if (_0x52c40c?.["code"] === "success") {
              console.log("账号[" + this.index + "] 开盲盒成功，获得：" + (_0x52c40c?.["data"]["prizeType"] == 1 ? _0x52c40c?.["data"]["prizeContent"] + "积分" : JSON.stringify(_0x52c40c.data)));
              return true;
...
function _0x3ebf60(_0x3fe7cd, _0x3151db) {
  ...
  return new class {
    ...
    ["setval"](_0x1bf108, _0x2b3834) {
      return this.isSurge() || this.isLoon() ? $persistentStore.write(_0x1bf108, _0x2b3834) : this.isQuanX() ? $prefs.setValueForKey(_0x1bf108, _0x2b3834) : this.isNode() ? (this.data = this.loaddata(), this.data[_0x2b3834] = _0x1bf108, this.writedata(), true) : this.data && this.data[_0x2b3834] || null;
    }
